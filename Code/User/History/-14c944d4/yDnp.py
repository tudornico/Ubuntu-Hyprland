# prepare_openai_model_ready_gpu_safe.py
import torch
...
# Enable PyTorch memory fragmentation fix if GPU is used
if DEVICE == "cuda":
...
MAX_LENGTH = 256          # shorter sequences save memory
...
training_args = TrainingArguments(
    ...
    logging_steps=10,
    save_strategy="epoch",
    fp16=False if DEVICE == "cuda" else False,  # 4-bit already saves memory
