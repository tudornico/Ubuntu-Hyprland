...
# ==========================
# LOAD MODEL (FP16 + CPU OFFLOAD)
# ==========================
print("Loading Mistral-7B with fp16 + CPU offload...")
model = AutoModelForCausalLM.from_pretrained(
    MODEL_NAME,
    device_map="auto",        # splits layers automatically across CPU/GPU
    offload_folder="offload", # offload unused layers to disk
