# prepare_openai_model_ready_optimized.py
import torch
...
MAX_LENGTH = 256  # shorter max_length to save memory
...
# Clear cache after model + LoRA init
...
training_args = TrainingArguments(
    ...
    logging_steps=10,
    save_strategy="epoch",
    fp16=False,  # 4-bit + LoRA is enough
