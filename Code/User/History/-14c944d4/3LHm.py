...
# Memory fragmentation / allocation settings
os.environ["PYTORCH_CUDA_ALLOC_CONF"] = "max_split_size_mb:64,garbage_collection_threshold:0.6,expandable_segments:True"
...
# ==========================
print("Loading model with 4-bit quantization and CPU offload...")
model = AutoModelForCausalLM.from_pretrained(
    MODEL_NAME,
    load_in_4bit=True,            # bitsandbytes will fallback to CPU
    device_map={"": "cpu"},       # forces all model on CPU
)
...
if __name__ == "__main__":
    ...
    # Move merged model to GPU for inference
